...
import { createExpType, getDetailExpTypeByCode, UpdateExpType } from '../../../service/userService';
    ...
    useEffect(() => {
        ...
        if (id) {
            let fetchDetailExpType = async () => {
                ...
                let allcode = await getDetailExpTypeByCode(id)
