...
import { createSalaryType, getDetailSalaryTypeByCode, UpdateSalaryType } from '../../../service/userService';
...
const AddSalaryType = () => {
    ...
    useEffect(() => {
        ...
        if (id) {
            let fetchDetailSalaryType = async () => {
                ...
                let allcode = await getDetailSalaryTypeByCode(id)
    ...
    let handleSaveSalaryType = async () => {
        ...
        if (isActionADD === true) {
            ...
            let res = await UpdateSalaryType({
                value: inputValues.value,
                code: id,
            })
            setTimeout(() => {
